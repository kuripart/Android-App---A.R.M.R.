...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean checkBluetoothDevice(){
        ...
        if(bluetoothAdapter!=null){ //check whether device supports bluetooth
            ...
            Toast.makeText(MainActivity.this, "This device does not support Bluetooth", Toast.LENGTH_SHORT);
        }
    ...
    public boolean BTconnect(){
        ...
        try{
            ...
            socket.connect();
            Toast.makeText(MainActivity.this, "Connection to bluetooth device successful", Toast.LENGTH_LONG).show();
        }catch(IOException e) {
            e.printStackTrace();
            connected = false;
        }
        ...
        if(connected){
            try{
                ...
                if(socket == null){
                    Toast.makeText(MainActivity.this, "no socket", Toast.LENGTH_LONG).show();
                }
                Toast.makeText(MainActivity.this, "output stream obtained", Toast.LENGTH_LONG).show();
            }catch(IOException e) {
                e.printStackTrace();
            }
        }
